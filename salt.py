...
X = 100  # (Stefan-Robin) Relie flux thermique et chimique. X grand -> Flux chimique petit.
Y = 100  # (Stefan-Robin) Deuxieme Nb sans dim dans la condition aux limites de Stefan-Robin
